...
export const SentenceExerciseSchema = z.union([
  VerbAspectExerciseSchema,
  RegularSentenceExerciseSchema
]);
...
export const ExerciseResponseSchema = z.union([
  ParagraphExerciseResponseSchema,
  SentenceExerciseResponseSchema
]);
