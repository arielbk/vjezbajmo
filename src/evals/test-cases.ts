...
export const VERB_TENSES_TEST_CASES: TestCase[] = [
  ...
  },
  {
    ...
    expectedExplanation: 'Incorrect tense. "Išao" is past tense, but the sentence indicates habitual present action ("svaki dan"). Should be "ide".',
  ...
  },
  {
    ...
    userAnswer: 'završim',
    expectedCorrect: true,
    expectedExplanation: 'Present tense in temporal clause expressing future completion. "Završim" is perfective present.',
...
export const NOUN_DECLENSION_TEST_CASES: TestCase[] = [
  {
    ...
    expectedCorrect: true,
    expectedExplanation: 'Locative case (where?) - masculine singular: "veliki" becomes "velikom", "grad" becomes "gradu".',
    difficultyLevel: 'medium',
  },
  {
    id: 'nd_02',
    ...
    expectedCorrect: true,
    expectedExplanation: 'Accusative case (what?) - feminine singular: "nova" becomes "novu", "knjiga" becomes "knjigu".',
    difficultyLevel: 'easy',
  },
  {
    id: 'nd_03',
    ...
    expectedCorrect: true,
    expectedExplanation: 'Instrumental case (with what?) - masculine singular: "mali" becomes "malim", "pas" becomes "psom".',
    difficultyLevel: 'medium',
  },
  {
    id: 'nd_04',
    ...
    expectedCorrect: false,
    expectedExplanation: 'Incorrect case. Nominative form used instead of locative. Should be "velikom gradu" for locative case (where?).',
    difficultyLevel: 'easy',
  },
  {
    id: 'nd_05',
  ...
  },
  {
    ...
    expectedCorrect: true,
    expectedExplanation: 'Locative case after "o" (about). Masculine singular: "važan" → "važnom", "problem" → "problemu".',
    difficultyLevel: 'medium',
  },
  {
    id: 'nd_07',
    ...
    expectedCorrect: true,
    expectedExplanation: 'Instrumental case with "s" (with). Feminine singular: "nova" → "novom", "igračka" → "igračkom".',
    difficultyLevel: 'medium',
  },
  {
    id: 'nd_08',
...
export const VERB_ASPECT_TEST_CASES: TestCase[] = [
  ...
  },
  {
    ...
    userAnswer: 'čekao',
    expectedCorrect: true,
    expectedExplanation: 'Imperfective "čekao" for duration ("cijeli dan"). Perfective "počekao" would be for a short wait.',
    difficultyLevel: 'medium',
  },
  {
    id: 'va_04',
    ...
    userAnswer: 'pođe',
    expectedCorrect: false,
    expectedExplanation: 'Incorrect aspect. Perfective "pođe" suggests one-time action, but "svaki dan" requires imperfective "ide" for habitual action.',
    difficultyLevel: 'medium',
  },
  {
    id: 'va_05',
  ...
  },
  {
    ...
    userAnswer: 'čita',
    expectedCorrect: true,
    expectedExplanation: 'Imperfective "čita" for habitual activity ("svake večeri"). Process-focused, not completion-focused.',
    difficultyLevel: 'easy',
  },
];
...
export const INTERROGATIVE_PRONOUNS_TEST_CASES: TestCase[] = [
  ...
  },
  {
    ...
    userAnswer: 'kojom',
    expectedCorrect: true,
    expectedExplanation: 'Instrumental case "kojom" (feminine singular) after preposition "s" (with), agreeing with "osobom".',
    difficultyLevel: 'medium',
  },
  {
    id: 'ip_03',
    ...
    expectedExplanation: 'Locative plural masculine "kojim" after "o" (about). "Kakvim" (what kind of) is also acceptable.',
    difficultyLevel: 'hard',
  },
  {
    id: 'ip_04',
    ...
    userAnswer: 'Koju',
    expectedCorrect: false,
    expectedExplanation: 'Incorrect case. "Koju" is accusative, but here we need nominative "koja" because "knjiga" is the subject.',
    difficultyLevel: 'medium',
  },
  {
    id: 'ip_05',
    ...
    userAnswer: 'Koju',
    expectedCorrect: true,
    expectedExplanation: 'Accusative feminine singular "koju" agreeing with "djecu" (collective feminine singular in accusative).',
    difficultyLevel: 'hard',
    notes: 'Tricky because "djeca" can be treated as feminine singular collective noun.',
  },
  {
    id: 'ip_06',
    exerciseType: 'interrogativePronouns',
...
export function isAnswerAcceptable(testCase: TestCase, userAnswer: string): boolean {
  ...
  if (testCase.alternativeCorrectAnswers) {
    return testCase.alternativeCorrectAnswers.some(
      alt => alt.toLowerCase().trim() === normalizedUserAnswer
    );
  }
